...
;
    ...
    return (
        <div className="container mx-auto">
           ...
           {
              reviews.map(item =>  <div key={item._id} className="w-full h-[250px] max-w-md px-8 relative  py-4 mt-16 bg-white border border-dashed border-main rounded-lg shadow-lg dark:bg-gray-800">
